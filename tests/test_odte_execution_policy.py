...
def test_live_posture_pins_tier_scaled_sizing():
    """2026-08-18 evening (operator): tier sizing restored to 2 on the resume. The lateness
    autopsy convicted ENTRY TIMING, not sizing — the freshness gate + 1-trade/day budget bound
    the worst day at one fresh 2-lot stop (~-$40, past the -$15 floor by design: the floor gates
    the NEXT entry, the stop bounds this one). b_plus/default stays 1."""
