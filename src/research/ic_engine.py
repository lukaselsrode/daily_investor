...
class FactorResearchEngine:
    ...
    def __init__(
        ...
        self._snap_cache: list[tuple[datetime.date, Path]] | None = None
    ...
    def compute_multi_horizon_ic(
        ...
        for h in use_horizons:
            ...
            for i, t_date in enumerate(sorted_dates):
                ...
                fwd_date: datetime.date | None = None
                best_diff = 9999
    ...
    def compute_regime_conditioned_ic(
        ...
        def _nearest_regime(d: datetime.date) -> str | None:
    ...
    def compute_cumulative_ic(
        ...
        for _, grp in ic_df.groupby("factor"):
