...
# ---------------------------------------------------------------------------
# Stability scan — RESEARCH / DIAGNOSTIC ONLY
# Never writes config.yaml. Never applies tuned parameters.
# ---------------------------------------------------------------------------
...
def run_stability_scan(
    ...
    for w_idx, n_days in enumerate(windows):
        ...
        # Average params across objectives that succeeded
        ...
        # Count unstable params for this window
    ...
    if n_unstable > max_allow:
        ...
        print(f"✓ Parameter count within stability budget.")
    print(f"{'='*64}")

    # Generate all reports — CSV, TXT, and PNG heatmaps
